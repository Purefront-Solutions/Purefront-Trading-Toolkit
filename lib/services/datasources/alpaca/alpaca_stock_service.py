...
class AlpacaStockService:
    ...
    def fetch_historical_bars(self, query_config: StockHistoricalBarsQueryType) -> Generator[list[AlpacaStockHistoricalBar], None, None]:
        params: dict = {
        ...
        while True:
            ...
            bars: list[AlpacaStockHistoricalBar] = []
    ...
    def test_connection(self) -> bool:
        ...
        response = requests.get(
            ...
            auth=(self._datasource_config.api_key, self._datasource_config.api_secret),
            headers={"accept": "application/json"},
            params={"symbols": "AAPL", "timeframe": "1D"},
        )
        response.raise_for_status()
        return True
