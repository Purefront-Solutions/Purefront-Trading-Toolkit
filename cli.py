...
def build_parser():
    ...
    collection_add.add_argument("--type", required=True, choices=["crypto-historical-bars"], help="collection type")
    ...
    collection_update.add_argument("--type", default=None, choices=["crypto-historical-bars"], help="collection type")
